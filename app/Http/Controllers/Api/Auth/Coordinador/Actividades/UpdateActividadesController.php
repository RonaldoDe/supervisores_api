...
class UpdateActividadesController extends Controller
{
            ...
            if($validacion==0)
            {
               ...
               for($i=0; $i<sizeof($fechas_converter_d);$i++)
               {
                ...
                if($validacionFechas==0){
                    ...
                    return response()->json(["Las fecha inicial o fecha final no pueden ser iguales por registros diferentes."],400);
                }
              ...
              if($validacion==0)
              {
                ...
                for($i=0; $i<sizeof($fechas_converter_d);$i++)
                {
                    ...
                    if($validacionFechas==0){
                        ...
                        return response()->json(["La fechas inicial y fechas final no pueden ser iguales."],400);
                    }
                 }
              }
              elseif($validacion>0)
    ...
    public function updateActividadPtc(Request $request){
